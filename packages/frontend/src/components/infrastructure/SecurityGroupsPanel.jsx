...
function SecurityGroupCard({ sg, env, currentProjectId, expanded, onToggle }) {
  ...
  const fetchRules = async () => {
    ...
    setError(null)
    try {
      const response = await fetchWithRetry(`/api/${currentProjectId}/infrastructure/${env}/security-group/${sgId}`)
      if (response.ok) {
